...
%Au plus tard la veille de votre soutenance, vous aurez envoyé à \url{crim@inalco.fr} et à \url{sophie.urbaniak@inalco.fr} un résumé de votre mémoire de 10 lignes maximum ainsi que 5 mots-clés permettant de situer votre travail, ainsi qu'un fichier pdf de votre mémoire qui sera mis en ligne pour consultation (sauf problèmes de confidentialité, à signaler) ainsi qu'une archive contenant, le cas échéant, programmes, corpus, données, polices de caractères, etc. Attention, ces informations doivent être le reflet fidèle de votre travail final.
